function renderHeader() {
    ...
    if (window.location.pathname.split("/").slice(2, 3) == "2015YouTube%20BETA%20(Mobile)" && (window.location.pathname.split("/").slice(3, 4) == "index.html" || window.location.pathname.split("/").slice(3, 4) == "index" || window.location.pathname.split("/").slice(3, 4) == undefined || window.location.pathname.split("/").slice(3, 4) == "") || window.location.pathname.split("/").slice(2, 3) !== "2015YouTube%20BETA%20(Mobile)" && (window.location.pathname.split("/").slice(2, 3) == "index.html" || window.location.pathname.split("/").slice(2, 3) == "index" || window.location.pathname.split("/").slice(2, 3) == undefined || window.location.pathname.split("/").slice(2, 3) == "")) {
    headerTitle.setAttribute("hidden", "");
    ...
    if (HEADER_CAST_ALTERNATE_ICON_expflag == "Holo") {
        castBtn.innerHTML = `<ytm15-icon class="search-icon"><svg viewBox="0 0 38 30" xmlns="http://www.w3.org/2000/svg"><path d="m1.93 0h34.08v2.93h-34.08zm33.08 0h3.01v26.92h-3.01zm-17.98 23.99h20.98v2.93h-20.98zm-15.1-23.99h3.01v11.88h-3.01z"/><path d="m0 14.25v2.7c2.18 0 4.2 0.54 6.08 1.63 1.87 1.09 3.34 2.55 4.41 4.39s1.61 3.85 1.61 6.03h2.71c0-2.68-0.66-5.15-1.98-7.41s-3.12-4.05-5.38-5.37c-2.27-1.32-4.74-1.98-7.43-1.98z"/><path d="m0 19.63v2.64c1.22 0 2.34 0.3 3.37 0.91s1.85 1.42 2.46 2.45 0.91 2.14 0.91 3.36h2.71c0-1.26-0.24-2.46-0.72-3.61s-1.17-2.17-2.05-3.04c-0.88-0.88-1.9-1.55-3.05-2.01s-2.36-0.69-3.62-0.69z"/><path d="m0 25.08c1.13 0 2.09 0.39 2.87 1.16 0.77 0.77 1.16 1.72 1.16 2.76h-4.03v-3.92z"/></svg></ytm15-icon>`;}
